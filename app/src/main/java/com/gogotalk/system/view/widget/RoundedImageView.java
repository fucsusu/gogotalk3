...
public class RoundedImageView extends AppCompatImageView {
    ...
    private static final ImageView.ScaleType[] SCALE_TYPES = {ImageView.ScaleType.MATRIX,
            ImageView.ScaleType.FIT_XY, ImageView.ScaleType.FIT_START, ImageView.ScaleType.FIT_CENTER,
            ImageView.ScaleType.FIT_END, ImageView.ScaleType.CENTER, ImageView.ScaleType.CENTER_CROP,
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.Custom_Round_Image_View, defStyle, 0);

        int index = a
                .getInt(R.styleable.Custom_Round_Image_View_android_scaleType, -1);
        if (index >= 0) {
        ...
        cornerRadius = a.getDimensionPixelSize(
                R.styleable.Custom_Round_Image_View_corner_radius, -1);
        borderWidth = a.getDimensionPixelSize(
                R.styleable.Custom_Round_Image_View_border_width, -1);
        ...
        borderColor = a
                .getColorStateList(R.styleable.Custom_Round_Image_View_border_color);
        if (borderColor == null) {
        ...
        mutateBackground = a.getBoolean(
                R.styleable.Custom_Round_Image_View_mutate_background, false);
        isOval = a.getBoolean(R.styleable.Custom_Round_Image_View_oval, false);
    ...
    /**
     * Controls how the image should be resized or moved to match the height of
     * this ImageView.
     *
